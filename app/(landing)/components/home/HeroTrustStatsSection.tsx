...
const HeroTrustStatsSection = () => {
  return (
    ...
    >
      ...
      <article className="flex flex-col items-center justify-center border-l-2 border-l-gray-200 pl-2 text-center md:pl-6">
        <span
          className="text-lg font-bold text-green-600 md:text-xl lg:text-2xl"
          role="img"
      ...
      <article className="flex flex-col items-center justify-center border-l-2 border-l-gray-200 pl-2 text-center md:pl-6">
        <span
          className="text-lg font-bold text-purple-600 md:text-xl lg:text-2xl"
          role="img"
          aria-label="جامعه کاربران"
        >
          👥
        </span>
        <span className="text-xs font-medium text-gray-500 md:text-sm">
      ...
      <article className="flex flex-col items-center justify-center pl-2 text-center md:pl-6">
        <span
...
export default HeroTrustStatsSection;
