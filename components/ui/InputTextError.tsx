...
const InputTextError: React.FC<InputTextErrorProps> = ({
  message,
  className,
}) => {
    ...
    >
      {hasError && (
        <>
          <span
            aria-hidden="true"
            className="block h-1.5 w-1.5 shrink-0 animate-pulse rounded-full bg-red-500 shadow-[0_0_4px_1px_rgba(239,68,68,0.6)]"
          />
